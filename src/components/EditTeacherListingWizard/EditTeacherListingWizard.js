...
import EditTeacherListingWizardTab from './EditTeacherListingWizardTab';
...
const createReturnURL = (returnURLType, rootURL, routes, pathParams) => {
  console.log('returnURL :', returnURLType);
...
class EditTeacherListingWizard extends Component {
  ...
  render() {
    ...
    if (!tabsStatus[selectedTab]) {
      ...
      return <NamedRedirect name="EditTeacherListingPage" params={{ ...params, tab: nearestActiveTab }} />;
    }
    ...
    console.log('successURL, failureURL :', successURL, failureURL);
