...
import { sendEnquiry, loadData, setInitialValues } from '../ListingPage/ListingPage.duck';
...
import SectionBioMaybe from './SectionBioMaybe';
import SectionSubjectMaybe from './SectionSubjectMaybe';
import SectionTeachingHoursMaybe from './SectionTeachingHoursMaybe';
          ...
          <LayoutWrapperMain>
            <div>
              <SectionImages
                ...
                routeName={'EditTeacherListingPage'}
              />
...
TeacherListingPageComponent.defaultProps = {
  ...
  subjectConfig: config.custom.subjects,
  levelConfig: config.custom.levels,
  teachingHoursConfig: config.custom.teachingHours,
};
